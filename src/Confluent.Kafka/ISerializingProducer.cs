...
namespace Confluent.Kafka
{
    public interface ISerializingProducer<TKey, TValue>
    {
        ...
        // void ProduceAsync(string topic, TKey key, TValue val, DateTime timestamp, int partition, bool blockIfQueueFull, IDeliveryHandler<TKey, TValue> deliveryHandler);
        // void ProduceAsync(string topic, TKey key, TValue val, DateTime timestamp, int partition, IDeliveryHandler<TKey, TValue> deliveryHandler);
        // void ProduceAsync(string topic, TKey key, TValue val, DateTime timestamp, IDeliveryHandler<TKey, TValue> deliveryHandler);
